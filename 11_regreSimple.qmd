...
![Para cada punto se indica su residuo. A la derecha, ecuación de la recta.](Figuras_11/f1101_resiRecta.png){#fig-resiRecta .fig-normal_1101 fig-align="center"}
...
![Ajuste a ojo y el que minimiza la suma de los cuadrados de los residuos.](Figuras_11/f1102_regresionAOjo.png){#fig-regresionAOjo .fig-normal_1102 fig-align="center"}
...
![Ajuste por el método de Ishikawa y el que minimiza la suma de los cuadrados de los residuos.](Figuras_11/f1103_regresionIshikawa.png){#fig-regresionIshikawa .fig-normal_1103 fig-align="center"}
...
![Dos ajustes -claramente muy malos- con suma de residuos igual a cero.](Figuras_11/f1104_residuosSuma.png){#fig-residuosSuma .fig-normal_1104 fig-align="center"}
...
![Posibles rectas que minimizan la suma de los residuos en valor absoluto.](Figuras_11/f1105_residuosValorAbsoluto.png){#fig-residuosValorAbsoluto .fig-normal_1105 fig-align="center"}
...
![Ajustes obtenidos minimizando la suma de valores absolutos y la suma de los cuadrados de los residuos.](Figuras_11/f1106_residuosMinimosCuadrados.png){#fig-residuosMinimosCuadrados .fig-normal_1106 fig-align="center"}
...
![Recta ajustada a ojo (izquierda) y suma de los cuadrados de los residuos para cada par de valores $b_0$ y $b_1$. En rojo, valores que la minimizan (derecha).](Figuras_11/f1107_coeficientesSinFormulas.png){#fig-coeficientesSinFormulas .fig-normal_1107 fig-align="center"}
...
![Relación muy clara y relación inexistente, situaciones que no pueden distinguirse solo a la vista del modelo ajustado.](Figuras_11/f1108_ArbolMano.png){#fig-ArbolMano .fig-normal_1108 fig-align="center"}
...
![Aprovechando la información aportada por la estatura disminuimos la suma de los cuadrados de los residuos.](Figuras_11/f1109_R2.png){#fig-R2 .fig-normal_1109 fig-align="center"}
...
![El gráfico de residuos frente a valores previstos pone de manifiesto de forma clara que la relación entre $X$ e $Y$ no es lineal.](Figuras_11/f1110_analisisResiduos.png){#fig-analisisResiduos .fig-normal_1110 fig-align="center"}
...
![Ajuste a un modelo cuadrático y gráfico de residuos frente a valores previstos.](Figuras_11/f1111_residuosModCuadra.png){#fig-residuosModCuadra .fig-normal_1111 fig-align="center"}
...
![La relación se linealiza con el cambio de variable: $x' = 1/x$](Figuras_11/f1112_molinoViento.png){#fig-molinoViento .fig-normal_1112 fig-align="center"}
...
![Ir aumentando el grado del polinomio produce modelos con ajustes "forzados" que no sirven para hacer previsiones.](Figuras_11/f1113_ajustePolinomio.png){#fig-ajustePolinomio .fig-normal_1113 fig-align="center"}
...
![Diagrama bivariante, con histogramas marginales, del peso del cerebro frente al peso del cuerpo de 62 especies de mamíferos.](Figuras_11/f1114_brainBodyOriginal.png){#fig-brainBodyOriginal .fig-normal_1114 fig-align="center"}
...
![Peso del cerebro frente al peso del cuerpo antes y después de la transformación logarítmica.](Figuras_11/f1115_brainBodyTransfo.png){#fig-brainBodyTransfo .fig-normal_1115 fig-align="center"}
...
![Recta ajustada a partir de los datos de una muestra.](Figuras_11/f1116_unaRegresionVA.png){#fig-unaRegresionVA .fig-normal_1116 fig-align="center"}
...
![Rectas ajustadas a partir de muestras de n=20 datos de una misma población. La línea negra representa el modelo teórico.](Figuras_11/f1117_regresionVariablesAleatorias.png){#fig-regresionVariablesAleatorias .fig-normal_1117 fig-align="center"}
...
![Superposición de 6 (izquierda) y 50 (derecha) simulaciones de conjuntos de 20 datos del modelo representado con una línea verde.](Figuras_11/f1118_regreVAsuperpuestas.png){#fig-regreVAsuperpuestas .fig-normal_1118 fig-align="center"}
...
![Distribución de los coeficientes.](Figuras_11/f1119_distribucionCoeficientes.png){#fig-distribucionCoeficientes .fig-normal_1119 fig-align="center"}
...
![La variabilidad de las rectas ajustadas depende del rango de X.](Figuras_11/f1120_regreRangoX.png){#fig-regreRangoX .fig-normal_1120 fig-align="center"}
...
![Modelos ajustados y valores característicos de cada conjunto de datos.](Figuras_11/f1121_ArbolManoModelos.png){#fig-ArbolManoModelos .fig-normal_1121 fig-align="center"}
...
![Rectas ajustadas considerando que no hay relación entre las variables y recta obtenida con los datos de la muestra (color verde).](Figuras_11/f1122_pruebasSignaficacion.png){#fig-pruebasSignaficacion .fig-normal_1122 fig-align="center"}
...
![Salida del paquete de software estadístico Minitab al ajustar modelos de regresión en los dos ejemplos que hemos visto.](Figuras_11/f1123_salidaSoftwareRegresion.png){#fig-salidaSoftwareRegresion .fig-normal_1123 fig-align="center"}
...
![La recta ajustada no se confunde con las de pendiente igual a 1.](Figuras_11/f1124_pendiente1.png){#fig-pendiente1 .fig-normal_1124 fig-align="center"}
...
![Ajuste habitual (mínimos cuadrados) y forzando a que la recta pase por el origen.](Figuras_11/f1125_salidaConcentracion.png){#fig-salidaConcentracion .fig-normal_1125 fig-align="center"}
...
![Recta ajustada y bandas de confianza del 95 %](Figuras_11/f1126_bandasConfianza.png){#fig-bandasConfianza .fig-normal_1126 fig-align="center"}
...
![No se debe extrapolar fuera del rango de variación de los datos ni usar modelos de regresión para hacer previsiones de datos obtenidos en orden cronológico.](Figuras_11/f1127_extrapolarSerieTiempo.png){#fig-extrapolarSerieTiempo .fig-normal_1127 fig-align="center"}
...
![Datos que no cumplen las condiciones exigidas para realizar estimaciones de la forma habitual.](Figuras_11/f1128_triangulos.png){#fig-triangulos .fig-normal_1128 fig-align="center"}
...
![Transformando los valores de alguna de las variables --o de ambas-- se puede mejorar su comportamiento.](Figuras_11/f1129_triangulosTransfo.png){#fig-triangulosTransfo .fig-normal_1129 fig-align="center"}

...
![Valor de la media de nuestra muestra situado en la distribución de la media muestral (azul).](Figuras_09/f0902_contrasteNormal.png){#fig-contrasteNormal .fig-normal6 fig-align="center" width="82%"}
...
![Cálculo del p-valor cuando $\sigma$ es conocida y se utiliza la N(0;1) como distribución de referencia.](Figuras_09/f0903_pValorNormal.png){#fig-pValorNormal .fig-normal6 fig-align="center" width="60%"}
...
![Cálculo del p-valor usando como distribución de referencia una $t$-Student con 9 grados de libertad. A trazos una N(0; 1).](Figuras_09/f0904_pValort.png){#fig-pValort .fig-normal6 fig-align="center" width="65%"}
...
![Cálculo del p-valor. A trazos una N(0; 1).](Figuras_09/f0906_pValorDifMed.png){#fig-pValorDifMed .fig-normal6 fig-align="center" width="70%"}
...
![Distribución binomial con parámetros n = 11037 y p = 0,00942, y distribución Normal con su misma media y desviación típica usada como aproximación.](Figuras_09/f0907_aproxNormal.png){#fig-aproxNormal .fig-normal6 fig-align="center" width="68%"}
...
![Distribución de referencia, estadístico de prueba y p-valor en el estudio sobre la influencia de aspirina en los infartos de miocardio.](Figuras_09/f0908_pValorPropor.png){#fig-pValorPropor .fig-normal6 fig-align="center" width="110%"}
...
![Valores de los estadísticos de prueba y su posición en la distribución de referencia.](Figuras_09/f0912_pValorChi2NuevosDados.png){#fig-pValorChi2NuevosDados .fig-normal6 fig-align="center" width="75%"}
...
[^09_algunostest-5]: Para la simulación hemos usado los parámetros de las poblaciones identificadas como A en la tabla \ref{parametrosDistribuciones}, pero el valor de los parámetros no cambia los resultados obtenidos.
...
![Valores generados aleatoriamente de una distribución $\chi^2$ con 3 grados de libertad y su representación bajo esa distribución.](Figuras_09/f0921_ejemploMiTesto.png){#fig-ejemploMiTesto .fig-normal6 fig-align="center" width="90%"}
...
![Distribución de referencia y $p$-valor obtenidos aplicando nuestro test.](Figuras_09/f0922_distRef_ejemploMio.png){#fig-ejemploMio .fig-normal6 fig-align="center" width="90%"}
...
![$p$-valor obtenido al realizar nuestro test frente al obtenido al realizar el de S-W a muestras de una población $\chi^2$ con $\nu=3$ y los tamaños que se indican.](Figuras_09/f0923_comparaSW_Mio.png){#fig-comparaSW_Mio .fig-normal6 fig-align="center" width="100%"}

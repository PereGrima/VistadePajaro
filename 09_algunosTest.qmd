...
```{=html}
<div class="tabla-wrapper_T0900aa">
<table class="tabla-0900aa">
...
<tbody>
<tr>
  <td>916</td> <td>940</td> <td>975</td> <td>969</td> <td>996</td> <td>1020</td> <td>1036</td> <td>1009</td> <td>990</td> <td>999</td>
</tr>
</tbody>
</table>
</div>
...
![Diagrama de puntos de los pesos de 10 paquetes de café (en g).](Figuras_09/f0901_dotplotPesoCafe.png){#fig-dotplotPesoCafe .fig-normal_0901 fig-align="center"}
...
Supongamos que tenemos muchos pesos de esos paquetes de manera que podemos considerar $\sigma = 30\;\text{g}$. Cuando todo marcha correctamente el peso de un paquete será un valor de la distribución: $X \sim  \text{N}(1000\;g; 30\; \text{g})$ y la distribución de la media de 10 paquetes será: $$\bar{x}_{10} \sim \text{N} \left( 1000; \frac{30}{\sqrt{10}} \right)$$ Ya solo falta ver si la media de nuestra muestra es un valor normal en esta distribución. El gráfico de la [@fig-contrasteNormal] --construido a escala-- muestra que es un caso dudoso.

![Valor de la media de nuestra muestra situado en la distribución de la media muestral (azul).](Figuras_09/f0902_contrasteNormal.png){#fig-contrasteNormal .fig-normal_0902 fig-align="center"}
...
Transformamos el valor de la media en un valor de la distribución Normal estandarizada. De esta forma, la distribución de referencia siempre será la misma. Recordemos que si $X \sim \text{N}(\mu; \sigma)$, entonces $\frac{x-\mu}{\sigma} \sim \text{N}(0; 1)$. En nuestro caso tenemos: $$\bar{X}_{10} \sim \text{N} \left( \mu; \frac{\sigma}{\sqrt{n}} \right)$$ Por tanto: $$z = \frac{\bar{x}_{10} - \mu} {\frac{\sigma}{\sqrt{n}}} \sim \text{N}(0; 1)$$ Sustituyendo por los valores correspondientes obtenemos nuestro estadístico de prueba: $$z = \frac{985 - 1000} {\frac{30}{\sqrt{10}}} = -1{,}58$$
...
![Cálculo del p-valor cuando $\sigma$ es conocida y se utiliza la N(0;1) como distribución de referencia.](Figuras_09/f0903_pValorNormal.png){#fig-pValorNormal .fig-normal_0903 fig-align="center"}
...
![Cálculo del p-valor usando como distribución de referencia una $t$-Student con 9 grados de libertad. A trazos una N(0; 1).](Figuras_09/f0904_pValort.png){#fig-pValort .fig-normal_0904 fig-align="center"}
...
![Representación gráfica del peso de los tomates obtenidos en cada planta según pertenezcan al grupo sin abono (Control) o con abono (Tratado).](Figuras_08/f0811_dotplot.png){#fig-dotplot .fig-normal_0905 fig-align="center"}
...
Siendo $\bar{y}_A$ e $\bar{y}_B$ las medias de cada muestra, $\mu_A$ y $\mu_B$ las medias poblacionales, $\sigma^2$ la varianza, que consideramos igual para las dos poblaciones, y $n$ el tamaño de las muestras, en nuestro caso el mismo para ambas. (ver [Tabla 9.1](#tbl-distDifMedias)})
...
El estadístico de prueba y la distribución de referencia son ahora: $$\frac{\bar{y}_B - \bar{y}_A}{\sqrt{\frac{2s^2}{n}}} \quad \;\sim \quad \; t-\text{Student con } \nu = 2n -2 \text{ g.l.}$$ Todos los valores que intervienen en el cálculo del estadístico de prueba --le llamamos $t$-- se obtienen a partir de los datos de las muestras: 
$$t = \frac{\bar{y}_B - \bar{y}_A}{\sqrt{\frac{2s^2}{n}}} = \frac{6{,}150 - 5{,}104}{\sqrt{\frac{2\cdot 1{,}069}{10}}} = 2{,}26$$ 
y los grados de libertad de la $t$-Student son la suma de los que aporta cada muestra, en nuestro caso $9+9=18$. Ahora toca valorar si el estadístico de prueba es un valor "normal" en la distribución de referencia.

![Cálculo del p-valor. A trazos una N(0; 1).](Figuras_09/f0906_pValorDifMed.png){#fig-pValorDifMed .fig-normal_0906 fig-align="center"}
...
Volvamos al estudio visto en el apartado 8.5 sobre si tomar cierta dosis de aspirina de manera regular reduce el riesgo de padecer infarto de miocardio. En el estudio participaron 22.071 individuos que fueron asignados aleatoriamente a uno de los dos grupos: el grupo de control que tomó un placebo, y el que tomó aspirina. Los resultados obtenidos fueron los que se indican en la [Tabla 9.2](#tbl-tablaResultadosAspirina) donde escribimos $\hat{p}_1$ y $\hat{p}_2$ para las proporciones en las muestras, con "sombrero" para distinguirlas de $p_1$ y $p_2$ que serán las proporciones en las poblaciones y son sobre las que nos planteamos saber si son diferentes.

```{=html}
<div id="tbl-tablaResultadosAspirina" class="tabla-wrapper_T0902">
<table class="tabla-0902">

<caption>Tabla 9.2: Resultados del estudio sobre aspirina e infarto de miocardio.</caption>
...
<tr>
  <td></td>
  <td>Grupo Placebo <br> (control)</td>
  <td>Grupo Aspirina <br> (tratado)</td>  
</tr>
...
<tr>  
  <td> Ocurrencias (infartos de miocardio) </td>
  <td>$$x_1$$ = 189 </td>
  <td>$$x_2$$ = 104</td>
</tr>

<tr>  
  <td> Proporciones en las muestras </td>
  <td>$$\hat{p}_1$$ = 0,01713</td>
  <td>$$\hat{p}_2$$ = 0,00942</td> 
</tr>
...
![Distribución binomial con parámetros n = 11037 y p = 0,00942, y distribución Normal con su misma media y desviación típica usada como aproximación.](Figuras_09/f0907_aproxNormal.png){#fig-aproxNormal .fig-normal_0907 fig-align="center"}
...
Recordemos que si $X$ es una variable aleatoria con distribución binomial y parámetros $n$, $p$, tenemos que: $\text{E}(X) = np$ y $V(X)=np(1-p)$. Además, si se cumplen las condiciones para poder aproximar la distribución de $X$ a través de una Normal: $$X \sim \text{N} \left(np; \sqrt{np(1-p)}\right)$$ Lo aproximado es la forma de la distribución, los valores de la esperanza matemática y de la desviación típica son esos exactamente.
...
![Distribución de referencia, estadístico de prueba y p-valor en el estudio sobre la influencia de aspirina en los infartos de miocardio.](Figuras_09/f0908_pValorPropor.png){#fig-pValorPropor .fig-normal_0908 fig-align="center"}
...
```{=html}
<div id="tbl-distDifMedias" class="tabla-wrapper_T0900c">
<table class="tabla-0900c">
...
<tr>
  <td>Frecuencia observada $$(O_i)$$:</td>
  <td>3407</td>
  <td>3631</td>
  <td>3176</td>
  <td>2916</td> 
...
A diferencia de la Normal o la $t$-Student, la distribución $\chi^2$ es asimétrica (cola larga hacia la derecha) y al igual que la $t$-Student no es una distribución única sino que hay que indicar cuáles son sus grados de libertad. En el caso de $Q$, sigue una distribución chi-cuadrado con $k-1$ grados de libertad[^09_algunostest-2].

[^09_algunostest-2]: De forma similar al cálculo de la varianza, aunque tenemos $k$ sumandos, solo aportan información $k-1$. El $k$-ésimo se puede deducir si te tiene el resto ya que $\sum_{i=1}^k x_i = k\,\bar{x}$.
...
![Estadístico de prueba $Q = 94,189$ y distribución $\chi^2$ con $\nu = 5$ grados de libertad.](Figuras_09/f0909_pValorChi2.png){#fig-pValorChi2 .fig-normal_0909 fig-align="center"}
...
![Lanzamiento de un dado. Histograma de 100;!000 valores de $Q = \sum_{i=1}^{k} \frac{(O_i-E_i)^2}{E_i}$ obtenidos por simulación y distribución $\chi^2$ con $\nu=5$ superpuesta.](Figuras_09/f0910_histoChi2.png){#fig-histoChi2 .fig-normal_0910 fig-align="center"}

### Otros resultados, no tan exagerados {.unnumbered}

Supongamos que con otros dos dados, uno verde y otro azul, los resultados al realizar 20;!000 lanzamientos son los que se indican en la [Tabla 9.3](#tbltablaNuevosDados).

```{=html}
<div id="tbl-tablaNuevosDados"; class="tabla-wrapper_T0903">
<table class="tabla-0903">

<caption>Tabla 9.3: Posibles resultados de lanzar 20.000 veces dos nuevos dados.</caption>
...
<tr>
  ...
  <td colspan="6" class="sin-inf">Resultados</td>
</tr>

<tr>
  <td class="sin-sup">Dado</td>
  <td class="sin-sup">1</td>
  <td class="sin-sup">2</td>
  <td class="sin-sup">3</td>
  <td class="sin-sup">4</td>
  <td class="sin-sup">5</td>
  <td class="sin-sup">6</td>
</tr>

<tr>
  <td class="sin-inf">Verde</td>
  <td class="sin-inf">3268</td>
  <td class="sin-inf">3364</td>
  <td class="sin-inf">3369</td>
  <td class="sin-inf">3409</td>
  <td class="sin-inf">3367</td>
  <td class="sin-inf">3223</td>
</tr>

<tr>
  <td class="sin-sup">Azul</td>
  <td class="sin-sup">3495</td>
  <td class="sin-sup">3219</td>
  <td class="sin-sup">3305</td>
  <td class="sin-sup">3314</td>
  <td class="sin-sup">3413</td>
  <td class="sin-sup">3254</td>
</tr>
...
![Representación de los resultados obtenidos con los dados verde y azul.](Figuras_09/f0911_nuevosDados.png){#fig-nuevosDados .fig-normal_0911 fig-align="center"}

Un test estadístico aportará información relevante para valorar esta situación. Elegimos el estadístico de prueba que tiene como distribución de referencia una $\chi^2$ con 5 grados de libertad, los valores obtenidos son 7,65 para el dado verde y 15,91 para el azul. Los cálculos se encuentran en la [Tabla 7.1](#tbl-estPruebaNuevosDados) y en la [@fig-pValorChi2NuevosDados] se han colocado esos valores en la distribución de referencia.

```{=html}
<div id="tbl-estPruebaNuevosDados" class="tabla-wrapper_T0901">
<table class="tabla-0904">

<caption>Tabla 9.4: Cálculo del estadístico de prueba para los resultados de los nuevos dados.</caption>
...
<tr>
  <td></td>
  <td></td>
  <td>1</td> <td>2</td> <td>3</td> <td>4</td> <td>5</td> <td>6</td> <td>Total</td>
</tr>

<tr>  
  <td rowspan="3">Verde</td>
  <td> Observadas ($$\small{O_V}$$) </td> 
  <td>3268</td> <td>3364</td> <td>3369</td> <td>3409</td> <td>3367</td> <td>3223</td> <td>20000</td>
</tr>

<tr>  
  <td> Esperadas ($$\small{E}$$) </td>
  <td>3333,3</td> <td>3333,3</td> <td>3333,3</td> <td>3333,3</td> <td>3333,3</td> <td>3333,3</td> <td>20000</td>
</tr>

<tr>  
  <td> Discrepancia ($$\scriptsize{\frac{(O_V-E)^2}{E}}$$) </td>
  <td>1,28</td> <td>0,28</td> <td>0,38</td> <td>1,72</td> <td>0,34</td> <td>3,65</td> <td>7,65</td>
</tr>

<tr>  
  <td rowspan="3">Azul</td>
  <td> Observadas ($$\small{O_A}$$) </td> 
  <td>3495</td> <td>3219</td> <td>3305</td> <td>3314</td> <td>3413</td> <td>3254</td> <td>20000</td>
</tr>
...
<tr>  
  <td> Discrepancia ($$\scriptsize{\frac{(O_V-E)^2}{E}}$$) </td>
  <td>7,84</td> <td>3,92</td> <td>0,24</td> <td>0,11</td> <td>1,90</td> <td>1,89</td> <td>15,91</td>
</tr>
...
![Valores de los estadísticos de prueba y su posición en la distribución de referencia.](Figuras_09/f0912_pValorChi2NuevosDados.png){#fig-pValorChi2NuevosDados .fig-normal_0912 fig-align="center"}
...
En un contexto industrial, supongamos que cuando todo funciona de la forma habitual el 85 % de las unidades producidas son correctas, el 10 % tienen algún defecto que se puede corregir y el 5 % restante son defectuosas sin arreglo. En la última semana se han fabricado 5.000 unidades, consideremos las situaciones, A y B, que se indican en la [Tabla 9.5](#tbl-ejemploIndustrial).

```{=html}
<div id="tbl-ejemploIndustrial"; class="tabla-wrapper_T0905">
<table class="tabla-0905">

<caption>Tabla 9.5: Calidad de las piezas en dos situaciones A y B.</caption>
...
<tr>
  <td>Defectuosas pero reparables:</td>
  <td>10%</td>
  <td>550 (11%)</td>
  <td>530 (10,6%)</td>
</tr>
...
<tr>
  <td>Defectuosas no reparables:</td>
  <td>5%</td>
  <td>275 (5,5%)</td>
  <td>270 (5,4%)</td>
</tr>
...
![Representación gráfica de los resultados en las situaciones consideradas.](Figuras_09/f0913_industrialChi2.png){#fig-industrialChi2 .fig-normal_0913 fig-align="center"}

Realizando el test de Chi-cuadrado los estadísticos de prueba son 8,82 para la situación A y 3,99 para la B ([Tabla 9.6](#tbl-testChiEjeIndustrial)).

```{=html}
<div id="tbl-testChiEjeIndustrial" class="tabla-wrapper_T0906">
<table class="tabla-0906">

<caption>Tabla 9.6: Cálculo de los estadísticos de prueba para el test de Chi-cuadrado..</caption>
...
<tr>
  ...
  <td>4250 (85%)</td> 
  <td>500 (10%)</td> 
  <td>250 (5%)</td> <td>4</td> <td>5</td> <td>6</td> <td>Total</td>
  <td>5000</td>
</tr>
...
<tr>  
  <td rowspan="2">A</td>
  <td> Observadas ($$\small{O_A}$$) </td> 
  <td>4175</td> <td>550</td> <td>275</td> <td>5000</td>
</tr>

<tr>  
  <td> Discrepancia ($$\scriptsize{\frac{(O_A-E)^2}{E}}$$) </td>
  <td>1,32</td> <td>5</td> <td>2,5</td> <td>8,82</td>
</tr>

<tr>  
  <td rowspan="2">B</td>
  <td> Observadas ($$\small{O_B}$$) </td> 
  <td>4200</td> <td>530</td> <td>270</td> <td>5000</td>
</tr>

<tr>  
  <td> Discrepancia ($$\scriptsize{\frac{(O_B-E)^2}{E}}$$) </td>
  <td>0,59</td> <td>1,8</td> <td>1,6</td> <td>3,99</td>
</tr>
</tbody>
</table>
</div>
...
<tr>
  <td rowspan="2"> Uniforme<sup>1</sup></td>
  <td>A</td>
  <td>$$\small{a=0;\;\; b=6}$$</td> 
  <td>$$\small{3{,}0}$$</td> 
  <td>$$\small{\sqrt{3}}$$</td>
...
<tr>
  <td>B</td>
  <td>$$\small{a=0{,}6;\;\; b=6{,}6}$$</td> 
  <td>$$\small{3{,}6}$$</td> 
  <td>$$\small{\sqrt{3}}$$</td>
</tr>

<tr>
  <td rowspan="2"> Exponencial<sup>2</sup></td>
  <td>A</td>
  <td>$$\small{\theta=3-\sqrt{3};\;\; \lambda=\sqrt{3}}$$</td> 
  <td>$$\small{3{,}0}$$</td> 
  <td>$$\small{\sqrt{3}}$$</td>
</tr>
...
<tr>
  <td>B</td>
  <td>$$\small{\theta=3{,}6-\sqrt{3};\;\; \lambda=\sqrt{3}}$$</td> 
  <td>$$\small{3{,}6}$$</td> 
  <td>$$\small{\sqrt{3}}$$</td>
</tr>

<tr>
  <td rowspan="2"> Laplace<sup>3</sup></td>
  <td>A</td>
  <td>$$\small{\mu=3;\;\; b=\sqrt{1{,}5}}$$</td> 
  <td>$$\small{3{,}0}$$</td> 
  <td>$$\small{\sqrt{3}}$$</td>
</tr>
...
<tr>
  <td colspan = "5"><sup>1</sup> <em>a</em> y <em>b</em> son los valores entre los cuales está definida la distribución.</td>
</tr>
<tr>
  <td colspan = "5"><sup>2</sup> &theta; es el umbral a partir del cual empieza la distribución y &lambda; el valor medio. </td>
</tr>
<tr>
  <td colspan = "5"><sup>3</sup> &mu; es el valor medio y <em>b</em> está relacionado con la variabilidad</td>
</tr>
</tbody>
</table>
</div>
...
![Distribución de p-valores obtenidos al comparar dos medias con el test de la t-Student según sea la distribución origen de los datos.](Figuras_09/f0914_pValorNoNormal.png){#fig-pValorNoNormal .fig-normal_0914 fig-align="center"}
...
![Función densidad de probabilidad y función de distribución de una N(0;1).](Figuras_09/f0915_funcionDistribucion.png){#fig-funcionDistribucion .fig-normal_0915 fig-align="center"}

Por otra parte, dada una muestra podemos definir su función de distribución empírica, $F_n(x)$, sustituyendo probabilidades por proporciones. Hemos generado 5 números aleatorios de una distribución N(0; 1) que, una vez ordenados de menor a mayor, son los que se indican a continuación, junto con sus proporciones acumuladas.

```{=html}
<div class="tabla-wrapper_T0900d">
<table class="tabla-0900d">
...
<tbody>
<tr>
  <td>Valor (<em>X</em>):</td> <td>-1,72</td> <td>-0,68</td> <td>-0,34</td> <td>0,54</td> <td>1,55</td>
</tr>
<tr>
  <td>Proporción acumulada F<sub>n</sub>(<em>X</em>):</td> <td>0,2</td> <td>0,4</td> <td>0,6</td> <td>0,8</td> <td>1</td>
</tr>
</tbody>
</table>
</div>
...
El estadístico de prueba es la distancia máxima, $D_{max}$ entre la función de distribución teórica --la que figura en la hipótesis nula-- y la empírica correspondiente a los datos disponibles. Si con los datos de nuestro ejemplo contrastamos la hipótesis nula de que pertenecen a una N(0; 1) tendremos los valores de $F(X)$ que se indican en la [Tabla 9.8](#tbl-ejemploKS), donde también vemos que la distancia máxima entre ambas funciones de distribución corresponde al valor $x = -0.34$ y es igual a 0,233.

```{=html}
<div id="tbl-ejemploKS" class="tabla-wrapper_T0900d">
<table class="tabla-0900d">

<caption>Tabla 9.8: Cálculo de los estadísticos de prueba para el test de Chi-cuadrado.</caption>
...
<tbody>
<tr>
  <td>Valor (X):</td> <td>-1,72</td> <td>-0,68</td> <td>-0,34</td> <td>0,54</td> <td>1,55</td>
</tr>
<tr>
  <td>Proporción acumulada F<sub>n</sub>(<em>X</em>):</td> <td>0,2</td> <td>0,4</td> <td>0,6</td> <td>0,8</td> <td>1</td>
</tr>
<tr>
  <td>Proporción acum. en N(0; 1), F(<em>X</em>):</td> <td>0,043</td> <td>0,248</td> <td>0,367</td> <td>0,705</td> <td>0,939</td>
</tr>
<tr>
  <td>Distancia (D):</td> <td>0,157</td> <td>0,152</td> <td>0,233</td> <td>0,095</td> <td>0,061</td>
</tr>
</tbody>
</table>
</div>
...
La [@fig-normalErrorTipoII_SW] muestra los histogramas de los $p$-valores obtenidos en cada caso[^09_algunostest-5]. La proporción de veces que se rechaza la hipótesis nula puede variar ligeramente si se repite la simulación.

[^09_algunostest-5]: Para la simulación hemos usado los parámetros de las poblaciones identificadas como A en la [Tabla 9.7](#tbl-parametrosDistribuciones), pero el valor de los parámetros no cambia los resultados obtenidos.

![Histogramas de los $p$-valores obtenidos al realizar el test de Normalidad de Shapiro-Wilk a 10.000 muestras de los tamaños y distribuciones que se indican. Se muestra la proporción de veces que se rechaza la Normalidad con el nivel de significación habitual del 5 %.](Figuras_09/f0917_normalErrorTipoII_SW.png){#fig-normalErrorTipoII_SW .fig-normal_0917 fig-align="center"}
...
![Test de comparación de medias de la $t$-Student. Distribución del $p$-valor según sea la diferencia de medias.](Figuras_09/f0918_reflexionesPvalor.png){#fig-reflexionesPvalor_SW .fig-normal_0918 fig-align="center"}
...
$$\sum_{i=1}^{\nu} \left ( \frac{x_i - \mu}{\sigma} \right )^2 \sim \chi_{\nu}^2 $$ Tanto su media como su varianza están relacionadas con sus grados de libertad, concretamente $E(\chi_{\nu}^2)= \nu$ y $V(\chi_{\nu}^2)= 2\nu$. A diferencia de la $t$-Student, esta es una distribución asimétrica, pero a medida que aumentan los grados de libertad se va haciendo simétrica y pareciéndose cada vez más a una distribución Normal[^09_algunostest-6] ([@fig-Chi2]).

[^09_algunostest-6]: Aunque necesita bastantes más grados de libertad que la $t$-Student para poder ser tratada como una Normal. Este era un tema importante cuando los medios de cálculo eran escasos, ahora no tiene ninguna relevancia.

![Distribuciones $\chi^2$ con los grados de libertad ($\nu$) que se indican.](Figuras_09/f0920_Chi2.png){#fig-Chi2 .fig-normal_0920 fig-align="center"}
...
Respecto al uso de la distribución $\chi^2$ en los test de bondad de ajuste, como en el caso de los dados de Wolf, si la hipótesis nula es cierta, podemos considerar que las frecuencias de aparición para cada uno de los resultados posibles son variables aleatorias con distribución binomial[^09_algunostest-7]. Por otro lado, la distribución binomial se puede aproximar --si se cumplen ciertas condiciones-- a una distribución de Poisson, que, como vimos, está caracterizada por un solo parámetro $\lambda$ que es a la vez su media y su varianza. Además, a partir de un cierto valor de $\lambda$ la distribución de Poisson se puede aproximar a la Normal, de manera que si $X \sim \text{Pois}(\lambda)$ y se cumplen las condiciones para la aproximación, podemos considerar que: $X \sim \text{N}(\lambda; \sqrt{\lambda})$.

[^09_algunostest-7]: En realidad lo son de una distribución *multinomial*, que es una generalización de la binomial cuando se tienen más de dos resultados posibles. Si fueran un conjunto de binomiales, los resultados serían independientes, pero evidentemente no lo son.
...
Para obtener la muestra cuyo origen Normal vamos a contrastar generamos 20 números aleatorios de una distribución chi-cuadrado con 3 grados de libertad, una distribución asimétrica con cola larga hacia la derecha, bastante alejada de la Normal ([@fig-ejemploMiTesto]).

![Valores generados aleatoriamente de una distribución $\chi^2$ con 3 grados de libertad y su representación bajo esa distribución.](Figuras_09/f0921_ejemploMiTesto.png){#fig-ejemploMiTesto .fig-normal_0921 fig-align="center"}

En primer lugar identificamos los intervalos con el criterio establecido. Para cada uno de esos intervalos contamos la frecuencia observada ($f_o$) y la probabilidad de tener una observación en el caso de que los datos provengan de una distribución Normal con la media y la desviación típica de la muestra, en nuestro caso 3,079 y 2,814 respectivamente. Una vez tenemos los valores de $f_o$ y $f_t$ para cada intervalo, podemos calcular el cuadrado de su diferencia. La suma de esos cuadrados es el estadístico de prueba ([Tabla 9.9](#tbl-ejemploTestMio)).

```{=html}
<div id="tbl-ejemploTestMio" class="tabla-wrapper_T0909">
<table class="tabla-0909">

<caption>Tabla 9.9: Cálculo del estadístico de prueba para el test que hemos definido.</caption>
...
<tr>
  ...
  <td>Prob.</td>
  <td>$$\small{f_t}$$</td>
  <td>$$\small{(f_o - f_t)^2}$$</td>
</tr>

<tr>
<td>-999 &nbsp; &mdash; &nbsp; -4,2 </td> <td> 0 </td> <td> 0,00484 </td> <td> 0,09683 </td> <td> 0,00938 </td>
</tr>
<tr>
<td>-4,2 &nbsp; &mdash; &nbsp; -2,5 </td> <td> 0 </td> <td> 0,01886 </td> <td> 0,37711 </td> <td> 0,14221 </td>
</tr>
<tr>
<td>-2,5 &nbsp; &mdash; &nbsp; -0,8 </td> <td> 0 </td> <td> 0,06031 </td> <td> 1,20628 </td> <td> 1,45511 </td>
</tr>
<tr>
<td>-0,8 &nbsp; &mdash; &nbsp; 0,9  </td> <td> 4 </td> <td> 0,13533 </td> <td> 2,70666 </td> <td> 1,67274 </td>
</tr>
<tr>
<td>0,9 &nbsp; &mdash; &nbsp; 2,6   </td> <td> 8 </td> <td> 0,21307 </td> <td> 4,26138 </td> <td> 13,97731</td>
</tr>
<tr>
<td>2,6 &nbsp; &mdash; &nbsp; 4,3   </td> <td> 3 </td> <td> 0,23542 </td> <td> 4,70844 </td> <td> 2,91876 </td>
</tr>
<tr>
<td>4,3 &nbsp; &mdash; &nbsp; 6,0   </td> <td> 2 </td> <td> 0,18256 </td> <td> 3,65116 </td> <td> 2,72633 </td>
</tr>
<tr>
<td>6,0 &nbsp; &mdash; &nbsp; 7,7   </td> <td> 1 </td> <td> 0,09934 </td> <td> 1,98686 </td> <td> 0,97390 </td>
</tr>
<tr>
<td>7,7 &nbsp; &mdash; &nbsp; 9,4   </td> <td> 1 </td> <td> 0,03793 </td> <td> 0,75855 </td> <td> 0,05830 </td>
</tr>
<tr>
<td>9,4 &nbsp; &mdash; &nbsp; 11,1  </td> <td> 1 </td> <td> 0,01016 </td> <td> 0,20311 </td> <td> 0,63504 </td>
</tr>
<tr>
<td>11,1 &nbsp; &mdash; &nbsp; 12,8 </td> <td> 0 </td> <td> 0,00191 </td> <td> 0,03812 </td> <td> 0,00145 </td>
</tr>
<tr>
<td>12,8 &nbsp; &mdash; &nbsp; 14,5 </td> <td> 0 </td> <td> 0,00025 </td> <td> 0,00501 </td> <td> 0,00003 </td>
</tr>
<tr>
<td>14,5 &nbsp; &mdash; &nbsp; 999  </td> <td> 0 </td> <td> 0,00002 </td> <td> 0,00049 </td> <td> 0,00000 </td>
</tr>

<tr>  
  <td colspan="4">Estadístico de prueba: $$\sum (f_o - f_t)^2 =$$</td>
  <td> 24,57</td> 
</tr>
...
![Distribución de referencia y $p$-valor obtenidos aplicando nuestro test.](Figuras_09/f0922_distRef_ejemploMio.png){#fig-ejemploMio .fig-normal_0922 fig-align="center"}

...
![Diagrama bivariante de los datos obtenidos por Karl Pearson sobre las alturas de 1375 mujeres y la de una de sus hijas.](Figuras_10/f1001_bivaDatosPearson.png){#fig-bivaDatosPearson .fig-normal_1001 fig-align="center"}
...
![Cuatro situaciones que muestran diferentes grados de relación.](Figuras_10/f1002_medidaRelacion.png){#fig-medidaRelacion .fig-normal_1002 fig-align="center"}
...
![Deducción de la fórmula de la covarianza.](Figuras_10/f1003_covarianza.png){#fig-covarianza .fig-normal_1003 fig-align="center"}
...
<caption>Tabla 10.1: Covarianza. Pros y contras</caption>
...
![Cuarteto de Anscombe. Cuatro situaciones muy distintas pero con el mismo coeficiente de correlación ($r=0{,}816$) y la misma recta ajustada ($y=3+0{,}5x$).](Figuras_10/f1004_anscombe.png){#fig-anscombe .fig-normal_1004 fig-align="center"}
...
![Relación entre el peso de los frutos recogidos en 22 plantas y el tiempo transcurrido desde su plantación hasta la recolección.](Figuras_10/f1005_tiempoPeso.png){#fig-tiempoPeso .fig-normal_1005 fig-align="center"}
...
![Valores del coeficiente de correlación obtenidas por simulación.](Figuras_10/f1006_simulaCorre.png){#fig-simulaCorre .fig-normal_1006 fig-align="center"}
...
![Muertes por enfermedad cardiaca ($\times$ 100.000 habitantes) frente a consumo de vino (litros de alcohol) en los países que se indica en el año 1988.](Figuras_10/f1007_vino.png){#fig-vino .fig-normal_1007 fig-align="center"}
...
![Distribución del coeficiente de correlación según el tamaño, $n$, de la muestra considerada.](Figuras_10/f1008_contrarioNormal.png){#fig-contrarioNormal .fig-normal_1008 fig-align="center"}
...
<caption>Tabla 10.2: Coeficiente de correlación. Pros y contras</caption>

...
png("donutPoblacion.png", width=1282.5, height=674.5, res = 300)

nAfrica = sum(x$Cont == "Africa")
nAmerica = sum(x$Cont == "America")
nAsia = sum(x$Cont == "Asia")
nEuropa = sum(x$Cont == "Europa")
nOceania = sum(x$Cont == "Oceania")

t = 0.65
Values_1 = c(nAfrica, nAmerica, nAsia, nEuropa, nOceania)
Zona <- c("África","Améri.","Asia","Euro.", "Ocea.")

...
En la [@fig-ventajasRM] tenemos una variable $y$ que muestra una cierta relación con $x_1$ $\left( R^2 = 0{,}65 \right)$  pero prácticamente ninguna con $x_2$ $\left(R^2 = 0{,}12  \right)$, sin embargo, usando las dos en un modelo de regresión múltiple la explicación del comportamiento de $y$ es muy buena, obteniéndose un valor de $R^2 = 0{,}98$.
...
![Las variables $x_1$ y $x_2$ conjuntamente explican mucho mejor la respuesta que considerándolas por separado.](Figuras_12/f1201_ventajasRM.png){#fig-ventajasRM .fig-normal_1201 fig-align="center"}
...
Identificar cuales conviene incluir no es trivial. La [Tabla 12.1](#tbl-datosYX1X2X3) contiene los valores de una variable respuesta $y$, y tres posibles variables regresoras: $x_1$, $x_2$, $x_3$. También hemos representado los diagramas bivariantes de la respuesta frente a cada una de esas posibles variables regresoras ([@fig-YX1X2X3]).

```{=html}
<div id="tbl-datosYX1X2X3" class="tabla-wrapper_T1201">
<div class="tabla-caption">
  Tabla 12.1: Valores de una respuesta y tres posibles variables regresoras.
</div>

<table class="tabla-1201">
...
<tbody>
<tr> <td>Observación</td> <td><em>y</em></td> <td><em>x</em><sub>1</sub></td> <td><em>x</em><sub>2</sub></td> <td><em>x</em><sub>3</sub></td> </tr>

<tr><td>1 </td> <td> 22,17 </td> <td> 20,07 </td> <td> 22,56 </td> <td> 2,10</td>  </tr>
 <tr><td>2 </td> <td> 26,08 </td> <td> 13,14 </td> <td> 26,55 </td> <td> 12,94</td> </tr>
 <tr><td>3 </td> <td> 23,28 </td> <td> 21,05 </td> <td> 24,51 </td> <td> 2,23</td>  </tr>
 <tr><td>4 </td> <td> 12,56 </td> <td> 22,48 </td> <td> 12,84 </td> <td> -9,92</td> </tr>
 <tr><td>5 </td> <td> 18,12 </td> <td> 14,07 </td> <td> 20,79 </td> <td> 4,05</td>  </tr>
 <tr><td>6 </td> <td> 26,49 </td> <td> 29,49 </td> <td> 22,28 </td> <td> -3,00</td> </tr>
 <tr><td>7 </td> <td> 12,51 </td> <td> 7,17  </td> <td> 12,38 </td> <td> 5,33</td>  </tr>
 <tr><td>8 </td> <td> 19,19 </td> <td> 12,87 </td> <td> 17,58 </td> <td> 6,32</td>  </tr>
 <tr><td>9 </td> <td> 12,05 </td> <td> 13,77 </td> <td> 10,81 </td> <td> -1,72</td> </tr>
 <tr><td>10 </td> <td>21,15 </td> <td> 19,04 </td> <td> 18,67 </td> <td> 2,10</td>  </tr> 
 <tr><td>11 </td> <td>27,64 </td> <td> 28,34 </td> <td> 25,16 </td> <td> -0,70</td> </tr>
 <tr><td>12 </td> <td>27,79 </td> <td> 29,26 </td> <td> 24,10 </td> <td> -1,47</td> </tr>
 <tr><td>13 </td> <td>22,90 </td> <td> 27,02 </td> <td> 21,98 </td> <td> -4,12</td> </tr>
 <tr><td>14 </td> <td>22,22 </td> <td> 21,04 </td> <td> 22,66 </td> <td> 1,18</td>  </tr>
 <tr><td>15 </td> <td>22,87 </td> <td> 24,58 </td> <td> 24,48 </td> <td> -1,71</td> </tr>
 <tr><td>16 </td> <td>18,08 </td> <td> 19,47 </td> <td> 18,02 </td> <td> -1,39</td> </tr>
 <tr><td>17 </td> <td>18,46 </td> <td> 22,24 </td> <td> 19,95 </td> <td> -3,77</td> </tr>
 <tr><td>18 </td> <td>15,94 </td> <td> 13,57 </td> <td> 15,25 </td> <td> 2,37</td>  </tr>
 <tr><td>19 </td> <td>18,56 </td> <td> 12,66 </td> <td> 23,54 </td> <td> 5,91</td>  </tr>
 <tr><td>20 </td> <td>15,49 </td> <td> 10,29 </td> <td> 14,86 </td> <td> 5,20</td>  </tr>

</tbody>
</table>
</div>
```
![Respuesta frente a tres posibles variables regresoras. Se incluyen los valores del coeficiente de correlación.](Figuras_12/f1202_YX1X2X3.png){#fig-YX1X2X3 .fig-normal_1202 fig-align="center"}
...
Se trata de calcular todos los posibles modelos que se pueden obtener con las variables candidatas, ordenarlos con algún criterio razonable y presentar los mejores para elegir el que más convenga. Con $k$ variables candidatas se pueden construir $2^k$ modelos[^12_regremultiple-1].

[^12_regremultiple-1]: La primera variable puede estar o no estar en el modelo. para cada una de estas dos opciones existen otras dos para la segunda (ya tenemos $2^2$). Con $k$ variables tendremos $2^k$. Este número también incluye un modelo sin variables regresoras ($\hat{y} = \bar{y}$), si este no se quiere contar el número será $2^k -1$.
...
![Modelos para ajustar datos con una variable cualitativa.](Figuras_12/f1203_varCualitativa.png){#fig-varCualitativa .fig-normal_1203 fig-align="center"}
...
![](Figuras_12/f12035_modeloCualitativa_1.png){.fig-normal_1200a width=475px fig-align="center"}
...
![](Figuras_12/f12036_modeloCualitativa_2.png){.fig-normal_1200b width=500px fig-align="center"}
...
<tbody>
<tr> <td>Valores</td> <td colspan="6">Variables auxiliares</td> </tr>
<tr> <td>originales</td> <td><em>Z</em><sub>1</sub></td> <td><em>Z</em><sub>2</sub></td> <td><em>Z</em><sub>3</sub></td> <td><em>Z</em><sub>4</sub></td> <td><em>Z</em><sub>5</sub></td> <td><em>Z</em><sub>6</sub></td> </tr>

<tr> <td>Lunes</td>     <td>1</td> <td>0</td> <td>0</td> <td>0</td> <td>0</td>  <td>0</td> </tr>
<tr> <td>Martes</td>    <td>0</td> <td>1</td> <td>0</td> <td>0</td> <td>0</td>  <td>0</td> </tr>
<tr> <td>Miércoles</td> <td>0</td> <td>0</td> <td>1</td> <td>0</td> <td>0</td>  <td>0</td> </tr>
<tr> <td>Jueves</td>    <td>0</td> <td>0</td> <td>0</td> <td>1</td> <td>0</td>  <td>0</td> </tr>
<tr> <td>Viernes</td>   <td>0</td> <td>0</td> <td>0</td> <td>0</td> <td>1</td>  <td>0</td> </tr>
<tr> <td>Sábado</td>    <td>0</td> <td>0</td> <td>0</td> <td>0</td> <td>0</td>  <td>1</td> </tr>
<tr> <td>Domingo</td>   <td>0</td> <td>0</td> <td>0</td> <td>0</td> <td>0</td>  <td>0</td> </tr>
...
En el ámbito de los modelos predictivos, además de los métodos estadísticos clásicos (regresión, series de tiempo[^12_regremultiple-2]), la previsión puede abordarse mediante otras técnicas como las redes neuronales, que suelen ofrecer mayor capacidad predictiva a costa de menor interpretabilidad.

[^12_regremultiple-2]: No tratamos las series de tiempo --o series temporales-- que tienen como objetivo realizar previsiones cuando los valores están autocorrelacionados. En este caso intervienen conceptos como estacionalidad, periodicidad o tendencia. Estas técnicas no se incluyen en cursos introductorios.
...
![Cinco puntos se ajustan perfectamente a un polinomio de cuarto grado. No importa cuales sean esos puntos.](Figuras_12/f1204_puntosIgualParametros.png){#fig-puntosIgualParametros .fig-normal_1204 fig-align="center"}
...
![Valor anómalo que se detecta al realizar un diagrama bivariante, pero no analizando las variables una a una.](Figuras_12/f1205_anomalia2D.png){#fig-anomalia2D .fig-normal_1205 fig-align="center"}
...
```{=html}
<div class="tabla-wrapper_T1200">
<table class="tabla-1200">
...
<tbody>
<tr>
  <td><em>Y</em> (Respuesta):</td> <td>3</td> <td>1</td> <td>5</td>
</tr>
<tr>
  <td><em>X</em> (Variable regresora):</td> <td>5</td> <td>0</td> <td>4</td>
</tr>
...
![Visión geométrica del planteamiento matricial de un sencillo modelo de regresión simple e identificación del vector de valores previstos.](Figuras_12/f1206_vectores.png){#fig-vectores .fig-normal_1206 fig-align="center"}

Los vectores **U** y $\textbf{X}_{\textbf{1}}$ definen el plano que pasa por los puntos (0, 0, 0), (1, 1, 1) y (5, 0, 4). El vector correspondiente a los valores previstos $\mathbf{\hat{Y}}$ estará situado en ese mismo plano ya que es una combinación lineal de los vectores que aparecen en la matriz **X**: $$\mathbf{\hat{Y}}  = b_0 \cdot \mathbf{U} + b_1 \cdot \mathbf{X_1}$$ Por otra parte, minimizar la suma de los cuadrados de los residuos equivale a minimizar el módulo del vector: \$\mathbf{e} = \mathbf{Y} - \mathbf{\hat{Y}} \$. La forma de conseguirlo es haciendo que sea perpendicular al plano definido por $\mathbf{U}$ y $\mathbf{X_1}$. La ecuación de este plano se puede deducir teniendo en cuenta que pasa por los puntos (0, 0, 0), (1, 1, 1) y (5, 0, 4). Su expresión es: $$4x + y -5z = 0$$ y el punto de corte en este plano de una recta perpendicular trazada desde el punto (3, 1, 5) es: (29/7, 9/7, 25/7).
...
\end{equation*}
```
Lo cual es equivalente a plantear el producto matriz-vector con la matriz traspuesta $\mathbf{X'}$: $$\mathbf{X'e=0}$$
...
<tbody>
<tr>
  <td><em>Y</em>:</td> <td>1</td> <td>3</td> <td>4</td> <td>6</td> <td>8</td>
</tr>
<tr>
  <td><em>X</em><sub>1</sub>:</td> <td>0</td> <td>1</td> <td>0</td> <td>1</td> <td>2</td>
</tr>
<tr>
  <td><em>X</em><sub>2</sub>:</td> <td>0</td> <td>0</td> <td>1</td> <td>1</td> <td>1</td>
</tr>

...
Cuando los datos se presentan tabulados no hay que olvidar que cada uno se repite tantas veces como indica su **frecuencia absoluta**. En la [@tbl-tablaHijos], la variable considerada es el número de hijos por familia ($x$) y el número de familias para cada uno de esos valores es la frecuencia absolutaaaaa ($n$).

```{=html} 
<table id="tbl-tablaHijos" class="tabla-0201"> 
<caption> 
...
<tr> 
  <td class="fila-titulo">Número de hijos (<i>x</i>):</td> 
  <td>0</td> 
  <td>1</td> 
  <td>2</td> 
  <td>3</td> 
...
<tr> <td class="fila-titulo">Número de familias (<i>n</i>):</td> 
  <td>13</td> 
  <td>21</td> 
  <td>15</td> 
  <td>8</td> 

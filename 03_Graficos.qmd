...
![Histogramas de los datos recogidos en una panadería estratificados por máquina y por operario.](Figuras_03/f0301_histogramaPanaderia.png){#fig-histoPanaderia .fig-normal7 fig-align="center" width="90%"}
...
![Diagramas de puntos para comparar los resultados de dos tratamientos.](Figuras_03/f0302_dotplot.png){#fig-dotplot .fig-normal_0302 fig-align="center" width="90%"}
...
![Construcción de un boxplot. Las patas llegan hasta la última observación antes de entrar en la zona de anomalías.](Figuras_03/f0303_boxplotConstruccion.png){#fig-boxplotConstruccion .fig-normal3 fig-align="center" width="90%"}
...
![Datos de la panadería. Boxplots para comparar máquinas y operarios.](Figuras_03/f0304_boxplotPanaderia.png){#fig-boxplotPanaderia .fig-normal_0304 fig-align="center" width="90%"}
...
![Dos formas de representar la esperanza de vida en los 196 países del mundo según el continente al que pertenecen.](Figuras_03/f0305_boxplotEspeVida.png){#fig-boxplotEspeVida .fig-normal_0305 fig-align="center" width="90%"}
...
![Datos de la panadería. Evolución de los pesos en máquinas 1 y 2.](Figuras_03/f0306_evolucionPanaderia.png){#fig-evolucionPanaderia .fig-normal_0304 fig-align="center" width="90%"}
...
![Datos de la panadería. Evolución de los pesos en máquinas 1 y 2.](Figuras_03/f0307_evoEspVida.png){#fig-evoEspVida .fig-normal_0304 fig-align="center" width="90%"}
...
![Evolución de la esperanza de vida desde 1901 hasta 2019. Cada boxplot representa los valores de todos los países en el año correspondiente.](Figuras_03/f0308_evoBoxplotEspVida.png){#fig-evoBoxplotEspVida .fig-normal_0308 fig-align="center" width="90%"}
...
![Evolución de los salarios (izquierda) y de los salarios y el poder adquisitivo (derecha). Parece que los salarios crecen menos en el gráfico de la derecha, la diferencia está en la escala.](Figuras_03/f0309_salariosInflacion.png){#fig-salariosInflacion .fig-normal_0309 fig-align="center" width="90%"}
...
<tr><td>10</td><td>351,8</td><td>200</td><td>56,9</td></tr>
  ...
  <div style="flex: 1; text-align: center;">
    <img src="Figuras_03/f0310_poderAdquisitivo.png" style="max-width: 95%; height: auto;">
  </div>
</div>
</div>
```
![Salarios y poder adquisitivo. Los salarios se duplican en 10 años, pero la inflación es del 15% anual.](Figuras_03/f0000_figuraFantasma2.png){#fig-salariosPoderAdq .fig-normal_03fantasma fig-align="center" width="90%"}
...
![Dos formas de representar la evolución del número de parados en España en 2022 y 2023.](Figuras_03/f0311_paro.png){#fig-paro .fig-normal_0311 fig-align="center" width="90%"}
...
![Dos formas de representar la evolución del número de parados en España en 2022 y 2023.](Figuras_03/f0312_valorAcciones.png){#fig-valorAcciones .fig-normal3 fig-align="center" width="85%"}
...
![Relación entre esperanza de vida y renta per cápita en el año 2019 en países con más de 100.000 habitantes.](Figuras_03/f0313_espeVida_RentaPC.png){#fig-espeVida_RentaPC .fig-normal_0313 fig-align="center" width="90%"}
...
![La superficie de los puntos es proporcional al ratio de mortalidad infantil del país que representan.](Figuras_03/f0314_espeVida_RentaPC_mortInf.png){#fig-espeVida_RentaPC_mortInf .fig-normal_0313 fig-align="center" width="90%"}
...
![Esperanza de vida frente al índice de Gini y la renta per cápita en un gráfico 3D.](Figuras_03/f0315_Gini_rentaPC_EspVida.png){#fig-Gini_rentaPC_EspVida .fig-normal_0313 fig-align="center" width="85%"}
...
![Índice de Gini frente a renta per cápita, usando un código de colores para representar la esperanza de vida.](Figuras_03/f0316_Graf2D_Gini_rentaPC_EspVida.png){#fig-Graf2D_Gini_rentaPC_EspVida .fig-normal_0313 fig-align="center" width="90%"}
...
![Población en cada continente. Diagramas de pastel y de dónut.](Figuras_03/f0318_donutPiePoblacion.png){#fig-donutPiePoblacion .fig-normal3 fig-align="center" width="90%"}
...
![La población de cada país es proporcional a la superficie del rectángulo que lo representa. En el recuadro rojo hay 76 países --el 38,8%-- pero solo contienen el 1,5% de la población.](Figuras_03/f0319_rectPropor.png){#fig-rectPropor .fig-normal_0313 fig-align="center" width="90%"}
...
![Intervalo en que se encuentra el ratio de mortalidad infantil.](Figuras_03/f0320_mapaMundi_MortInf.png){#fig-mapaMundi_MortInf .fig-normal3 fig-align="center" width="90%"}
...
![Añadir una tercera dimensión es una mala opción cuando el objetivo es transmitir la información de la forma más clara posible.](Figuras_03/f0321_graficos3D.png){#fig-graficos3D .fig-normal_0313 fig-align="center" width="90%"}
...
![El diagrama 3D da la falsa sensación de que la sanidad es el sector más importante.](Figuras_03/f0322_pastel3D.png){#fig-pastel3D .fig-normal3 fig-align="center" width="90%"}
...
![¿Qué se puede decir de la máquina 3 respecto a la 1?](Figuras_03/f0323_distintasEscala.png){#fig-distintasEscala .fig-normal_0313 fig-align="center" width="90%"}
...
![La recta ajustada sugiere una relación que seguramente no existe y que solo es debida a la influencia de unos puntos singulares.](Figuras_03/f0324_rectaTendencia.png){#fig-rectaTendencia .fig-normal_0313 fig-align="center" width="90%"}
...
![La segunda casa es el triple de alta pero da la sensación de ser nueve veces mayor.](Figuras_03/f0325_casaConRayas.png){#fig-casaConRayas .fig-normal_0313 fig-align="center" width="80%"}
...
![Los círculos de la primera fila, con un diámetro proporcional al valor que representan, exageran las diferencias. En la segunda fila el área es proporcional al valor.](Figuras_03/f0326_circulo.png){#fig-circulo .fig-normal_0313 fig-align="center" width="90%"}
...
![Dos formas de representar la evolución de las exportaciones. Los datos son los mismos pero la impresión que dan los gráficos es muy diferente.](Figuras_03/f0327_exportaciones.png){#fig-exportaciones .fig-normal3 fig-align="center" width="90%"}
...
![Adaptando la escala al rango de variación de los datos se exageran las diferencias. En los diagramas de barras el eje vertical debe partir de cero.](Figuras_03/f0328_escalaBarra.png){#fig-escalaBarra .fig-normal_0313 fig-align="center" width="90%"}
...
![En el gráfico de la izquierda se exageran las diferencias, en el de la derecha apenas se notan.](Figuras_03/f0329_escalaLineas.png){#fig-escalaLineas .fig-normal_0313 fig-align="center" width="90%"}

![Escala vertical recomendada en gráficos que muestran una tendencia.](Figuras_03/f0330_escalaLineas2.png){#fig-escalaLineas2 .fig-normal3 fig-align="center" width="90%"}
...
![Diagrama bivariante realizado con Jamovi.](Figuras_03/f0331_CapturaJamovi.png){#fig-CapturaJamovi .fig-normal3 fig-align="center" width="90%"}
...
![Gráfico de burbujas realizado con la hoja de cálculo de Google.](Figuras_03/f0332_CapturaHCGoogle.png){#fig-CapturaHCGoogle .fig-normal3 fig-align="center" width="90%"}
...
![Esquema de un cuadro de mando. (Imagen: Freepik.com).](Figuras_03/f0333_dashboard.png){#fig-dashboard .fig-normal3 fig-align="center" width="90%"}

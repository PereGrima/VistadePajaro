...
![Histogramas de los datos recogidos en una panadería estratificados por máquina y por operario.](Figuras/f0301_histogramaPanaderia.png){#fig-histoPanaderia .fig-normal3 fig-align="center" width="90%"}
...
![Dos formas de representar la esperanza de vida en los 196 países del mundo según el continente al que pertenecen.](Figuras/f0305_boxplotEspeVida.png){#fig-boxplotEspeVida .fig-normal3 fig-align="center" width="90%"}
...
![Datos de la panadería. Evolución de los pesos en máquinas 1 y 2.](Figuras/f0306_evolucionPanaderia.png){#fig-evolucionPanaderia .fig-normal3 fig-align="center" width="95%"}
...
![Datos de la panadería. Evolución de los pesos en máquinas 1 y 2.](Figuras/f0307_evoEspVida.png){#fig-evoEspVida .fig-normal3 fig-align="center" width="100%"}
...
![Evolución de la esperanza de vida desde 1901 hasta 2019. Cada boxplot representa los valores de todos los países en el año correspondiente.](Figuras/f0308_evoBoxplotEspVida.png){#fig-evoBoxplotEspVida .fig-normal3 fig-align="center" width="100%"}
...
![Evolución de los salarios (izquierda) y de los salarios y el poder adquisitivo (derecha). Parece que los salarios crecen menos en el gráfico de la derecha, la diferencia está en la escala.](Figuras/f0309_salariosInflacion.png){#fig-salariosInflacion .fig-normal3 fig-align="center" width="100%"}
...
<colgroup>
  ...
  <div style="flex: 1; text-align: center;">
    <img src="Figuras/f0310_poderAdquisitivo.png" style="max-width: 95%; height: auto;">
  </div>

</div>
```
![Salarios y poder adquisitivo. Los salarios se duplican en 10 años, pero la inflación es del 15% anual.](Figuras/f0000_figuraFantasma2.png){#fig-salariosPoderAdq .fig-normal4 fig-align="center" width="100%"}
...
![Dos formas de representar la evolución del número de parados en España en 2022 y 2023.](Figuras/f0311_paro.png){#fig-paro .fig-normal3 fig-align="center" width="110%"}
...
![Dos formas de representar la evolución del número de parados en España en 2022 y 2023.](Figuras/f0312_valorAcciones.png){#fig-valorAcciones .fig-normal3 fig-align="center" width="110%"}
...
![Relación entre esperanza de vida y renta per cápita en el año 2019 en países con más de 100.000 habitantes.](Figuras/f0313_espeVida_RentaPC.png){#fig-espeVida_RentaPC .fig-normal3 fig-align="center" width="100%"}
...
![La superficie de los puntos es proporcional al ratio de mortalidad infantil del país que representan.](Figuras/f0314_espeVida_RentaPC_mortInf.png){#fig-espeVida_RentaPC_mortInf .fig-normal3 fig-align="center" width="100%"}
...
![Índice de Gini frente a renta per cápita, usando un código de colores para representar la esperanza de vida.](Figuras/f0316_Graf2D_Gini_rentaPC_EspVida.png){#fig-Graf2D_Gini_rentaPC_EspVida .fig-normal3 fig-align="center" width="100%"}
...
![Número de países en cada continente. A la derecha estratificados según el cuartil al que pertenecen según su renta per cápita.](Figuras/f0317_diagramaBarras.png){#fig-diagramaBarras .fig-normal3 fig-align="center" width="90%"}
...
![Población en cada continente. Diagramas de pastel y de dónut.](Figuras/f0318_donutPiePoblacion.png){#fig-donutPiePoblacion .fig-normal3 fig-align="center" width="100%"}
...
![La población de cada país es proporcional a la superficie del rectángulo que lo representa. En el recuadro rojo hay 76 países --el 38,8%-- pero solo contienen el 1,5% de la población.](Figuras/f0319_rectPropor.png){#fig-rectPropor .fig-normal3 fig-align="center" width="95%"}
...
![Intervalo en que se encuentra el ratio de mortalidad infantil.](Figuras/f0320_mapaMundi_MortInf.png){#fig-mapaMundi_MortInf .fig-normal3 fig-align="center" width="100%"}
...
![El diagrama 3D da la falsa sensación de que la sanidad es el sector más importante.](Figuras/f0322_pastel3D.png){#fig-pastel3D .fig-normal3 fig-align="center" width="100%"}
...
![¿Qué se puede decir de la máquina 3 respecto a la 1?](Figuras/f0323_distintasEscala.png){#fig-distintasEscala .fig-normal3 fig-align="center" width="95%"}
...
![La recta ajustada sugiere una relación que seguramente no existe y que solo es debida a la influencia de unos puntos singulares.](Figuras/f0324_rectaTendencia.png){#fig-rectaTendencia .fig-normal3 fig-align="center" width="90%"}
...
![La segunda casa es el triple de alta pero da la sensación de ser nueve veces mayor.](Figuras/f0325_casaConRayas.png){#fig-casaConRayas .fig-normal3 fig-align="center" width="75%"}
...
![Los círculos de la primera fila, con un diámetro proporcional al valor que representan, exageran las diferencias. En la segunda fila el área es proporcional al valor.](Figuras/f0326_circulo.png){#fig-circulo .fig-normal3 fig-align="center" width="100%"}
...
![Dos formas de representar la evolución de las exportaciones. Los datos son los mismos pero la impresión que dan los gráficos es muy diferente.](Figuras/f0327_exportaciones.png){#fig-exportaciones .fig-normal3 fig-align="center" width="90%"}
...
![Adaptando la escala al rango de variación de los datos se exageran las diferencias. En los diagramas de barras el eje vertical debe partir de cero.](Figuras/f0328_escalaBarra.png){#fig-escalaBarra .fig-normal3 fig-align="center" width="90%"}
...
![En el gráfico de la izquierda se exageran las diferencias, en el de la derecha apenas se notan.](Figuras/f0329_escalaLineas.png){#fig-escalaLineas .fig-normal3 fig-align="center" width="90%"}

![Escala vertical recomendada en gráficos que muestran una tendencia.](Figuras/f0330_escalaLineas2.png){#fig-escalaLineas2 .fig-normal3 fig-align="center" width="90%"}
...
![Diagrama bivariante realizado con Jamovi.](Figuras/f0331_CapturaJamovi.png){#fig-CapturaJamovi .fig-normal3 fig-align="center" width="100%"}
...
![Gráfico de burbujas realizado con la hoja de cálculo de Google.](Figuras/f0332_CapturaHCGoogle.png){#fig-CapturaHCGoogle .fig-normal3 fig-align="center" width="100%"}
...
![Esquema de un cuadro de mando. (Imagen: Freepik.com).](Figuras/f0333_dashboard.png){#fig-dashboard .fig-normal3 fig-align="center" width="100%"}

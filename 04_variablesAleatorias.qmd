...
![Representación de funciones de probabilidad de variables discretas.](Figuras_04/f0401_ejemplosFuncionProbabilidad.png){#fig-ejemplosFuncionProbabilidad .fig-normal_0401 fig-align="center"}
...
![Histograma con frecuencias absolutas (izquierda) y con densidad de frecuencia (derecha).](Figuras_04/f0402_densidadDeFrecuencia.png){#fig-densidadDeFrecuencia .fig-normal_0402 fig-align="center"}
...
![Histograma con frecuencias absolutas (izquierda) y con densidad de frecuencia (derecha).](Figuras_04/f0403_areasProbabilidades.png){#fig-areasProbabilidades .fig-normal_0403 fig-align="center"}
...
Para que una función pueda ser considerada *densidad de probabilidad* debe cumplir dos condiciones: que tome únicamente valores no negativos (es decir, positivos o cero) y que la integral en el intervalo en que está definida sea igual a 1.
:::
...
```{=html}
<div id="tbl-Juego"; class="tabla-wrapper_T0402">
...
![Función densidad de probabilidad con forma triangular.](Figuras_04/f0404_ejercicio.png){#fig-ejercicio .fig-normal_0404 fig-align="center"}
...
También se calcula con una expresión similar a la que usamos para calcular la varianza de una muestra. Si se trata de una variable aleatoria discreta, solo cambiamos la media de la muestra por la esperanza matemática de la población y la frecuencia relativa por la probabilidad, es decir: $$\text{V}(X) = \sum_{i=1}^k  [x_i - \text{E}(X)]^2 \, p(x_i)$$ Para el cálculo de la varianza del beneficio tenemos los valores de la [Tabla 4.3](#tbl-Juego):

```{=html}
<div id="tbl-Juego" class="tabla-wrapper_T0403">
<table class="tabla-0403">
...
-   $\text{V}(X-Y) = \text{V}(X) + \text{V}(Y) - 2\,\text{Cov}(X,Y)$ <br>
...
$\qquad \qquad \qquad \qquad \qquad  \text{E}(12X)=12 \cdot \text{E}(X)$ $\qquad \qquad \qquad \qquad \qquad  \text{V}(12X)=12^2 \cdot \text{V}(X)=144 \cdot \text{V}(X)$
...
![Una docena de huevos (exagerando las diferencias).](Figuras_04/f0405_huevos1.png){#fig-huevos1 .fig-normal_0405 fig-align="center"}
...
![Un huevo multiplicado por 12. Si es pequeño es como tener una docena de huevos pequeños. Igual si es grande.](Figuras_04/f0406_huevos2.png){#fig-huevos2 .fig-normal_0406 fig-align="center"}
...
-   Lanzamos dos dados: ¿cuál es la probabilidad de que la suma sea igual a 5? Antes hemos visto que existen 11 resultados posibles y 5 es uno de ellos, pero no todos tienen la misma probabilidad de ocurrir. Hemos visto en la [Tabla 4.1](#tbl-sumaDados) que esta probabilidad es 1/9, no 1/11.
...
![El valor de $R_n$ no debe ser de 10 sino de 11$\,\Omega$.](Figuras_04/f0407_circuito.png){#fig-circuito .fig-normal_0407 fig-align="center"}
...
<blockquote>Tenemos cuatro tarjetas con los símbolos A, D, 3 y 7 en una cara, y sabemos que todas ellas tienen un número en una cara y una letra en la otra. ¿Que tarjetas se deben girar para verificar que se cumple la regla: *si una tarjeta tiene una A en una cara, entonces tiene un 3 en la otra*?</blockquote>
...
```
En un grupo de 30 personas solo se pueden dar dos situaciones: todos han nacido en días diferentes o, como mínimo, dos han nacido el mismo día, no puede haber situaciones intermedias. Por tanto, si la probabilidad de que todos hayan nacido en días diferentes es $Q(30) = 0.2937$, la de que dos o más hayan nacido el mismo día será: $$ P(30) = 1- Q(30) = 1-0{,}2937 = 0{,}7063 $$

Es inmediato deducir que la expresión general para $P(n)$ es: $$P(n) = 1-Q(n) = 1- \frac{365!}{365^n(365-n)!} $$
...
![Construcción de la curva que relaciona la probabilidad de coincidencia en la fecha del cumpleaños y el número de personas en un grupo.](Figuras_04/f0409_probabilidadCoincidencia.png){#fig-probabilidadCoincidencia .fig-normal_0409 fig-align="center"}

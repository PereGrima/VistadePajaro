...
![Representación de funciones de probabilidad de variables discretas.](Figuras_04/f0401_ejemplosFuncionProbabilidad.png){#fig-ejemplosFuncionProbabilidad .fig-normal3 fig-align="center" width="90%"}
...
![Histograma con frecuencias absolutas (izquierda) y con densidad de frecuencia (derecha).](Figuras_04/f0402_densidadDeFrecuencia.png){#fig-densidadDeFrecuencia .fig-normal3 fig-align="center" width="95%"}
...
![Histograma con frecuencias absolutas (izquierda) y con densidad de frecuencia (derecha).](Figuras_04/f0403_areasProbabilidades.png){#fig-areasProbabilidades .fig-normal3 fig-align="center" width="95%"}
...
![Función densidad de probabilidad con forma triangular.](Figuras_04/f0404_ejercicio.png){#fig-ejercicio .fig-normal3 fig-align="center" width="60%"}
...
![Una docena de huevos (exagerando las diferencias).](Figuras_04/f0405_huevos1.png){#fig-huevos1 .fig-normal3 fig-align="center" width="90%"}
...
![Un huevo multiplicado por 12. Si es pequeño es como tener una docena de huevos pequeños. Igual si es grande.](Figuras_04/f0406_huevos2.png){#fig-huevos2 .fig-normal3 fig-align="center" width="100%"}
...
![El valor de $R_n$ no debe ser de 10 sino de 11$\,\Omega$.](Figuras_04/f0407_circuito.png){#fig-circuito .fig-normal3 fig-align="center" width="90%"}
...
![Posibles resultados si se siguiera jugando.](Figuras_04/f0408_partida.png){#fig-partida .fig-normal3 fig-align="center" width="85%"}
...
![Construcción de la curva que relaciona la probabilidad de coincidencia en la fecha del cumpleaños y el número de personas en un grupo.](Figuras_04/f0409_probabilidadCoincidencia.png){#fig-probabilidadCoincidencia .fig-normal3 fig-align="center" width="90%"}

...
![Diagrama de donut y de pastel](representacionesGraficas/salariosInflacion.png){#fig-donutPie fig-align="center" width="100%"}
...
![Salarios y poder adquisitivo](representacionesGraficas/poderAdquisitivo.png){#fig-donutPie fig-align="center" width="100%"}
:::
:::

text

![Diagrama de donut y de pastel](representacionesGraficas/paro.png){#fig-donutPie fig-align="center" width="100%"}

texto

![Diagrama de donut y de pastel](representacionesGraficas/casaSinRayas.png){#fig-donutPie fig-align="center" width="100%"}

texto

![Diagrama de donut y de pastel](representacionesGraficas/casaConRayas.png){#fig-donutPie fig-align="center" width="100%"}

texto

![Diagrama de donut y de pastel](representacionesGraficas/circulos.png){#fig-donutPie fig-align="center" width="100%"}

text

![Diagrama de donut y de pastel](representacionesGraficas/escalaHorizontalBarras.png){#fig-donutPie fig-align="center" width="100%"}

text

![Diagrama de donut y de pastel](representacionesGraficas/escalaHorizontalLineas.png){#fig-donutPie fig-align="center" width="100%"}

### Comparar situaciones usando distintas escalas

texto

![Diagrama de donut y de pastel](representacionesGraficas/histoDifEscalas.png){#fig-donutPie fig-align="center" width="100%"}

### Rectas de tendencia cuando los puntos están muy agrupados en una parte del diagrama

texto

![Diagrama de donut y de pastel](representacionesGraficas/rectaTendencia.png){#fig-donutPie fig-align="center" width="100%"}

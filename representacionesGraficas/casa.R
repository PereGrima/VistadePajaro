...
#png(file="casa.png",width=1300, height=1300, res = 300)
x <- 20
y <- 20
par(mar=c(0, 0, 0, 0))
plot(x, y, asp=1, ylim=c(-10, 10), xlim=c(-10, 10), ylab="", xlab="", col = "black", yaxt = 'n', xaxt='n', frame.plot = FALSE)
rect(-9, -10, -5, -6)
rect(-3, -10, 9, 2)
...
lines(c(-3, 9), c(-6,-6), lty=2)
lines(c(-3, 9), c(-2, -2), lty=2)
lines(c(1, 1), c(-10, 2), lty=2)
lines(c(5, 5), c(-10, 2), lty=2)

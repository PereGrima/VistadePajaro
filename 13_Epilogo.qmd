...
Esta es una creencia bastante extendida. Para ver si es cierta basta con tener los datos del número de nacimientos diarios y ver si en los días de luna llena se observa un incremento respecto al resto. El problema es que conseguir esos datos para un país o una región no siempre es fácil. En la página web del Instituto de Estadística de la Comunidad de Madrid están disponibles los de esa Comunidad desde 1975[^13_epilogo-1]. Es razonable suponer que esos datos se pueden considerar representativos de la población en general a efectos de la influencia de la luna llena en el número de nacimientos.
...
Aunque están en formato Excel y son fáciles de manejar, hay que reorganizarlos para facilitar su análisis. Los días de luna llena se pueden obtener fácilmente aunque, en rigor, la luna llena se produce en un instante y se considera día de luna llena el día en que se produce ese instante, sin importar la hora a que se produce. También hay que tener en cuenta que los días de luna llena dependen del huso horario.
...
![Nacimientos en la Comunidad de Madrid por día de la semana en los años 2020-2023. La raya horizontal representa el percentil del 90% para los valores de ese día/año. Los puntos rojos corresponden a los días de luna llena.](Figuras/f1301_lunaLlena.png){#fig-lunaLlena .fig-normal_1301 fig-align="center"}
...
![Número de nacimientos anuales los días entre semana (rojo) y los fines de semana (azul). Se han eliminado algunos valores claramente anómalos.](Figuras/f1302_boxPlotLuna.png){#fig-boxPlotLuna .fig-normal_1302 fig-align="center"}
...
![Esquema del montaje para medir la duración de una pila en una linterna.](Figuras/f1303_celulaFotoelectrica.png){#fig-celulaFotoelectrica .fig-normal_1303 fig-align="center"}
...
![Esquema del montaje para medir la duración de una pila en una linterna.](Figuras/f1304_cajaConLinterna.png){#fig-cajaConLinterna .fig-normal_1304 fig-align="center"}
...
[^13_epilogo-4]: En un libro titulado "Hierro en las espinacas …y otras creencias" (bajo la dirección de Jean-François Bouvet, editorial Suma de letras S. L., septiembre de 2000) se incluye un pequeño apartado sobre este tema. Después de una introducción, dice (sin disimular la ironía):
...
::: {#fig-fotoflores}
::: {layout-ncol="2"}
![](Figuras/f1305a_rosasMesa.png){width="360px"}

![](Figuras/f1305b_dosRosas.jpg){width="225px"}
:::
...
Esto es estadística y esto es método científico. <br>

...
Profundizar en el cálculo de probabilidades al principio de un curso de estadística es una mala idea porque, como este tema no es nada fácil ni intuitivo, muchos estudiantes llegan a la conclusión de que la estadística no es para ellos. Y es una lástima, porque calcular probabilidades no está entre los objetivos ni entre las prioridades de la estadística[^01_introduccion-1].

[^01_introduccion-1]: <small>Una de las características del cálculo de probabilidades es que es muy fácil pensar ejercicios sobre este tema y también es fácil corregirlos. Quizá eso tiene algo que ver con su papel protagonista en los cursos de estadística.</small>

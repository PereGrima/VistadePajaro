...
La [@fig-boxplotEspeVida] muestra la esperanza de vida en 2019 para cada uno de los 196 países del mundo, agrupados según el continente al que pertenecen (datos: Gapminder)[^22_graficos-2]. En el gráfico de la izquierda, la esperanza de vida de cada país se representa con un punto en la columna correspondiente a su continente. Los puntos se desplazan ligeramente de forma aleatoria en el eje horizontal para evitar la superposición y facilitar la percepción de su densidad.

[^22_graficos-2]: <small>[Gapminder](https://www.gapminder.org/data). Esta página web contiene datos económicos y de desarrollo en formatos fáciles de tratar. También es una fuente de inspiración sobre cómo visualizar esa información mediante gráficos no convencionales.</small>
...
A fin de poder valorar mejor la evolución de la variable considerada, es preferible que el eje horizontal solo incluya los 12 meses de un año y se representen por separado las líneas correspondientes a cada uno de los años considerados, como en la parte derecha de la [@fig-salariosPoderAdq][^22_graficos-3], sale distinto. La razón es que Minitab asigna los valores frontera al extremo inferior.

[^22_graficos-3]: <small>Datos: [Servicio Público de Empleo Estatal (España)](https://www.sepe.es/HomeSepe/que-es-el-sepe/estadisticas/empleo.html).</small>
...
Utilizando puntos de distinto color se identifica a qué continente pertenece cada país. África tiene la renta y la esperanza de vida más bajas. Además de observar la tendencia general, conocida como curva de Preston[^22_graficos-4], también tienen interés los puntos singulares, es decir, los países que tienen una esperanza de vida singularmente alta o baja en relación con su renta, sobre el diagrama se indican los nombres de algunos de estos países.

[^22_graficos-4]: <small>Puede consultar la Wikipedia, con mayor detalle en inglés.</small>
...
Recuerde que cuando analizamos una variable, debe estar muy claro a qué nos estamos refiriendo. Los gráficos que incluye [Gapminder](https://www.gapminder.org/data) informan con todo detalle sobre el significado de las variables que se incluyen, en particular, de los criterios usados para calcular la renta per cápita[^22_graficos-5]

[^22_graficos-5]: <small>Valores de la renta per cápita ajustados de acuerdo con las diferencias de poder adquisitivo, en dólares USA y con los precios basados en su Índice de Precios al Consumo de 2017. [Más detalles](https://www.gapminder.org/data/documentation/gd001)</small>
...
<caption>Tabla 3.7: Diagramas bivariantes. Pros y contras</caption>
...
<caption>Tabla 3.7: Diagramas 3D. Pros y contras.</caption>
...
![La población de cada país es proporcional a la superficie del rectángulo que lo representa. En el recuadro rojo hay 76 países --el 38,8\%-- pero solo contienen el 1,5\% de la población.](Figuras/f0319_rectPropor.png){#fig-rectPropor .fig-normal3 fig-align="center" width="100%"}

::: callout-note
## Ranking de medallas en los juegos olímpicos

No parece muy razonable que el ranking de medallas obtenidas en los Juegos Olímpicos se presente usando el país como unidad de comparación, colocando al mismo nivel a países como EE.UU. y a Dominica[^22_graficos-8].
:::

[^22_graficos-8]: <small>Aunque en los Juegos de París 2024, Dominica, un país con 71.500 habitantes, obtuvo una medalla de oro, y Santa Lucía, con 178.500, obtuvo una de oro y otra de plata. China debería haber obtenido casi 20.000 medallas de oro para igualar a Dominica en número de medallas por habitante.</small>
...
![¿Qué se puede decir de la máquina 3 respecto a la 1?](Figuras/f0323_distintasEscala.png){#fig-distintasEscala .fig-normal3 fig-align="center" width="100%"}
...
![La recta ajustada sugiere una relación que seguramente no existe y que solo es debida a la influencia de unos puntos singulares.](Figuras/f0324_rectaTendencia.png){#fig-rectaTendencia .fig-normal3 fig-align="center" width="100%"}
...
![La segunda casa es el triple de alta pero da la sensación de ser nueve veces mayor.](Figuras/f0325_casaConRayas.png){#fig-casaConRayas .fig-normal3 fig-align="center" width="100%"}
...
![Dos formas de representar la evolución de las exportaciones. Los datos son los mismos pero la impresión que dan los gráficos es muy diferente.](Figuras/f0327_exportaciones.png){#fig-exportaciones .fig-normal3 fig-align="center" width="100%"}
...
![Adaptando la escala al rango de variación de los datos se exageran las diferencias. En los diagramas de barras el eje vertical debe partir de cero.](Figuras/f0328_escalaBarra.png){#fig-escalaBarra .fig-normal3 fig-align="center" width="100%"}

#### Gráficos de serie temporal {.unnumbered}

En los gráficos de serie temporal las reglas son otras. No conviene que la escala vertical vaya del valor mínimo al máximo, como en la [@fig-escalaLineas] (izquierda), porque se exageran las diferencias, pero tampoco conviene partir siempre de cero, porque dependiendo de la magnitud representada, los cambios pueden ser relevantes y apenas notarse (derecha). Una interesante guía de estilo de *The Wall Street Journal*[^22_graficos-9] recomienda que el rango de variación de los datos ocupe aproximadamente dos tercios de la escala vertical, tal como hemos realizado en el gráfico de la [@fig-escalaLineas2]. Además, si lo que interesa es la variación más que los valores absolutos, es recomendable representar los porcentajes.

[^22_graficos-9]: <small>Dona M. Wong (2010): "The Wall Street Journal. Guide to Information Graphics".</small>

![En el gráfico de la izquierda se exageran las diferencias, en el de la derecha apenas se notan.](Figuras/f0329_escalaLineas.png){#fig-escalaLineas .fig-normal3 fig-align="center" width="100%"}

![Escala vertical recomendada en gráficos que muestran una tendencia.](Figuras/f0330_escalaLineas2.png){#fig-escalaLineas2 .fig-normal3 fig-align="center" width="100%"}
...
En esta línea de los lenguajes de programación, una alternativa a R es Python. Es una mejor opción para aprender a programar --o para tener un primer contacto con la programación-- y también permite realizar análisis estadísticos[^22_graficos-10]. Puede ser especialmente interesante en cursos impartidos en grados del ámbito de la ciencia o la tecnología en los que la programación con Python forma parte del plan de estudios.

[^22_graficos-10]: <small>Especialmente cuando es completado con el paquete [Pandas](https://pandas.pydata.org).</small>

Otra opción son los paquetes de software que utilizan el lenguaje y los algoritmos de R añadiendo una presentación con menús, de forma que el proceso de aprendizaje es muy corto y toda la energía se puede dedicar al análisis de los datos. De este tipo tenemos, entre otros[^22_graficos-11]:

[^22_graficos-11]: <small>Una revisión y comparación de los más conocidos se encuentra [aquí](https://r4stats.com/articles/software-reviews).</small>
...
Es un instrumento pensado para que los directivos y técnicos puedan seguir la marcha de su empresa con información relevante, veraz y actualizada para tomar en cada caso las decisiones que convenga. Naturalmente, también es útil para seguir la marcha de cualquier proceso u organización, en particular puede ser una herramienta interesante para seguir la evolución de los estudiantes en un centro docente[^22_graficos-12].

[^22_graficos-12]: <small>Puede ver un ejemplo [aquí](https://upcommons.upc.edu/handle/2117/356194) (en catalán)</small>}. 

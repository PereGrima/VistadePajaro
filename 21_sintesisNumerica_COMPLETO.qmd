...
Cuando los datos se presentan tabulados no hay que olvidar que cada uno se repite tantas veces como indica su **frecuencia absoluta**. En la <a href="#tabla-hijos">Tabla 2.1</a>, la variable considerada es el número de hijos por familia ($x$) y el número de familias para cada uno de esos valores es la frecuencia absoluta ($n$).

```{=html}
<div class="tabla-wrapper0201">
<table id="tabla-hijos" class="tabla-0201">

<caption>
  <!-- <span class="tabla-num">Tabla 2.1:</span> -->
  <span class="tabla-titulo">Número de hijos por familia</span>
</caption>
...
```{=html}
<table style="width:100%; border-collapse: collapse; margin-top: 1.5em; border-top: 2px solid #333;">
  <thead style="display:none;"><tr><th>Tipo</th><th>Descripción</th></tr></thead>
  <tbody>
    <tr style="border-bottom: 1px solid #dee2e6;">
      <td style="padding: 15px; vertical-align: middle; width: 25%;">
        <strong>PROS</strong> <i class="fa-solid fa-thumbs-up fa-xl" style="color: #0ca701;"></i>
      </td>
    ...
    <tr style="border-bottom: 1px solid #dee2e6;">
      <td style="padding: 15px; vertical-align: middle;">
        <strong>CONS</strong> <i class="fa-solid fa-thumbs-down fa-xl" style="color: #f03333;"></i>
      </td>
      <td style="padding: 15px; vertical-align: middle;">
        <ul style="margin: 0; padding-left: 20px;">
...
Simplemente elevamos las diferencias al cuadrado en vez de usar su valor absoluto. Si tenemos un conjunto de $N$ datos con media $\mu$ y queremos conocer la varianza de **esos datos**[^21_sintesisnumerica-1] usamos la expresión:

[^21_sintesisnumerica-1]: leyenda nota pie de página

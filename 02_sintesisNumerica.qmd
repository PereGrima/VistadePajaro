...
Los problemas con porcentajes pueden parecer triviales y no serlo. Uno de los más famosos es la llamada “paradoja de las patatas”: supongamos que tenemos 100 kg de patatas cuyo peso está compuesto por agua en un 99%. Con el paso del tiempo las patatas pierden humedad ¿Cuánto pesarán cuando el porcentaje de humedad sea del 98%?[^02_sintesisnumerica-1].

[^02_sintesisnumerica-1]: <small>Después de secarse sigue habiendo 1 kg de "polvo de patata"; si ese kg es un 2% del total, el total son 50 kg.</small>\
